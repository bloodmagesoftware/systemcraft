---
title: Shell
description: A shell is a user interface that lets users interact with an operating system by entering commands. It parses and executes those commands, manages program execution and I/O, and often provides scripting to automate tasks.
authors:
  - frank_mayer
tags:
  - Fundamentals
...
It reads user input from the keyboard (and sometimes the mouse) and executes other programs on behalf of the user as an [interpreter](/courses/tools/interpreters/).
