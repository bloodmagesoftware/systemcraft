---
title: Interpreter
description: An interpreter is a program that reads high-level source code and immediately carries out the instructions, translating and executing them step‑by‑step.
authors:
  - frank_mayer
tags:
  - Computer Science
