...
There are also hybrid approaches like [Just-in-time compilation](/courses/jit) (short JIT).
...
The first thing every kind of compiler/interpreter does is to read the source code into an Abstract Syntax Tree (AST).
